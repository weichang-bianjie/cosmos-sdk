...
type StreamingServiceConstructor func(opts servertypes.AppOptions, keys []sdk.StoreKey) (streaming.StreamingService, error)
...
func FileStreamingConstructor(opts servertypes.AppOptions, keys []sdk.StoreKey) (streaming.StreamingService, error) {
